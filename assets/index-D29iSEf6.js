(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const l of t.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&a(l)}).observe(document,{childList:!0,subtree:!0});function o(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function a(e){if(e.ep)return;e.ep=!0;const t=o(e);fetch(e.href,t)}})();class p extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `;const s=this.querySelector("#scroll-indicator"),o=s.querySelector("span"),a=s.querySelector("div"),e=a.querySelector("span"),t=this.querySelectorAll("section"),l=this.querySelector("#last-section");[s,o,a,e].forEach(r=>r.classList.add("transition-colors","duration-500","transition-opacity","duration-500"));const f=new IntersectionObserver(([r])=>{const d=r.target,n=d.dataset.indicatorColor;Array.from(o.classList).forEach(i=>{i.startsWith("text-")&&o.classList.remove(i)}),o.classList.add(`text-${n}`),n==="white"?(o.classList.add("text-shadow-glow-white"),o.classList.remove("text-shadow-glow-green")):(o.classList.add("text-shadow-glow-green"),o.classList.remove("text-shadow-glow-white")),Array.from(a.classList).forEach(i=>{i.startsWith("border-")&&i!=="border-2"&&a.classList.remove(i)}),a.classList.add(`border-${n}`),Array.from(e.classList).forEach(i=>{i.startsWith("bg-")&&e.classList.remove(i)}),e.classList.add(`bg-${n!=="white"?"green-500":""}`),n==="white"&&(e.style.backgroundColor="white"),d.id==="last-section"&&(s.style.opacity=r.isIntersecting?"0":"1",s.style.pointerEvents=r.isIntersecting?"none":"auto")},{threshold:.6});t.forEach(r=>f.observe(r)),new IntersectionObserver(([r])=>{s.style.opacity=r.isIntersecting?"0":"1",s.style.pointerEvents=r.isIntersecting?"none":"auto"},{threshold:.6}).observe(l)}}customElements.define("home-page",p);class h extends HTMLElement{connectedCallback(){this.innerHTML=`
    ...
    `}}customElements.define("not-found-page",h);(async()=>await import("/ionic.esm.js"))();
